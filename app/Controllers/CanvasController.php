    ...
    public function analyzeLayout() {
        ...
        try {
            ...
            $prompt = "당신은 파렛트랙(Pallet Rack) 전문 설계 AI입니다. 아래 정보로 설치 계획을 수립하세요.\n\n"
                ...
                . "   - 예: 총 59칸을 한 라인에 연속 배치할 경우, 독립형은 1대, 연결형은 58대가 됩니다. (단, 기둥이나 입구로 인해 라인이 나뉘면 독립형이 추가됩니다.)\n"
                ...
                . '{"summary":"전체 설계 요약 2~3문장(한국어)","recommended_levels":단수숫자,"rack_depth_mm":숫자,"beam_length_mm":숫자,"aisle_width_mm":숫자,"notes":["주의사항1","주의사항2"],"estimated_independent":숫자,"estimated_connected":숫자}';
