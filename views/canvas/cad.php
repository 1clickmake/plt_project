...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (diagramContainer) {
        let guideHtml = '<p class="text-info fw-bold py-3 m-0">우측 캔버스에 점을 찍어 창고 모양을 완성해주세요!</p>';
        if (isMobile) {
            guideHtml += '<div class="alert alert-info py-2 px-3 small border-0 mt-1" style="border-radius:8px; font-size:0.8rem; background:rgba(14,165,233,0.15); color:#38bdf8;">'
                       + '📱 <strong>모바일 접속</strong>: 터치로 랙을 자유롭게 이동 및 조작할 수 있습니다. (직사각형 창고는 상단 <strong>간편 모드</strong>를 이용하시면 더 빠릅니다!)</div>';
        }
        diagramContainer.innerHTML = guideHtml;
    }
